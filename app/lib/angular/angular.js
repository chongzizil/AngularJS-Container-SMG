 ...
 *
 * @param {String} name Name of the filters function to retrieve
 * @return {Function} the filters function
 */
 ...
 *
 *   - `Object`: A pattern object can be used to filters specific properties on objects contained
 ...
 *     determining if the expected value (from the filters expression) and actual value (from
   ...
   <example>
     <file name="index.html">
       ...
       <table id="searchTextResults">
         ...
         <tr ng-repeat="friend in friends | filters:searchText">
           <td>{{friend.name}}</td>
           <td>{{friend.phone}}</td>
         </tr>
       </table>
       ...
       <table id="searchObjResults">
         <tr><th>Name</th><th>Phone</th></tr>
         <tr ng-repeat="friendObj in friends | filters:search:strict">
 ...
 *
 * @param {number} amount Input to filters.
 ...
 *
 *   This filters is mostly useful for debugging. When using the double curly {{value}} notation
 *   the binding is automatically converted to JSON.
 *
 * @param {*} object Any JavaScript object (including arrays and primitive types) to filters.
 ...
 * </div>
 * <div class="alert alert-warning">
 * **Note**: If you have assignment in `ngInit` along with {@link ng.$filter `$filters`}, make
 ...
 *
 * @animations
 * **.enter** - when a new item is added to the list or when an item is revealed after a filters
 *
 ...
 *     property is same.
 *
 *     For example: `item in items | filters:searchText track by item.id` is a pattern that might be used to apply a filters
  ...
  <example module="ngAnimate" deps="angular-animate.js" animations="true">
    <file name="index.html">
      <div ng-init="friends = [
        ...
        <input type="search" ng-model="q" placeholder="filters friends..." />
        <ul class="example-animate-container">
          <li class="animate-repeat" ng-repeat="friend in friends | filters:q">
    ...
    <file name="protractor.js" type="protractor">
      ...
      it('should render initial data set', function() {
       ...
       it('should update repeater when filters predicate changes', function() {
         expect(friends.count()).toBe(10);
